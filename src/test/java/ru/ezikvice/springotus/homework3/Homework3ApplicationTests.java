package ru.ezikvice.springotus.homework3;
...
public class Homework3ApplicationTests {
    ...
    public void testUserExamination() {
        ...
        given(this.mockQaSService.examine(questionMap))
                .willReturn(userExamination);

        UserExamination examineResults = mockQaSService.examine(questionMap);
